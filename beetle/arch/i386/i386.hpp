...
#pragma region "Arch interruptions"
	__attribute__((interrupt)) void interruptDE  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptDB  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptNMI (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptBP  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptOF  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptBR  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptUD  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptNM  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptDF  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptCS  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptTS  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptNP  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptSS  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptGP  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptPF  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptMF  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptAC  (const void* ptr, const int errorCode);
	__attribute__((interrupt)) void interruptMC  (const void* ptr, const int errorCode);
